...
<svg xmlns="http://www.w3.org/2000/svg"
  ...
  <!-- Kreis -->
  <circle cx="0" cy="60" r="30" fill="blue" />

  <!-- Rechteck -->
  <rect x="-50" y="120" width="100" height="50" fill="green" />
</svg>
    </code>
</details>
...
<details>
    ...
    Durch die Anzahl der # vor einem Text wird die Überschriftsebene bestimmt.
# = große Überschrift (H1), ## = kleinere (H2), usw. bis ###### (H6).
</details>
<details>
...
Die Seitenzahlen beginnen auf der rechten Seite (ungerade).
Kapitel beginnen auf neuer Seite.
Andere Formatierung für Überschriften.
Titel wird zentriert auf einer eigenen Seite dargestellt.
</details>
<details>
    <summary>What changes in your pdf, if you add <code>\section{Intro}</code> after <code>\maketitle</code></summary>
Es wird eine neue Überschrift mit der Nummerierung 1 Intro angezeigt.
Dies beginnt einen Abschnitt im Dokument.
</details>
...
Die Schrift wird deutlich größer, da <h1> eine Überschrift 1. Ordnung ist.
Sie wird standardmäßig fett angezeigt.
</details>
